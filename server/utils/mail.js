...
export async function sendApplicationConfirmationEmail({ to, fullName, internshipType, internshipMode, domain, role, rollNo, collegeName, city, mobileNumber }) {
  if (!to) {
    return { skipped: true };
  }
    ...
    <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #0f172a; background: #f8fafc; padding: 24px;">
      <div style="max-width: 640px; margin: 0 auto; background: #ffffff; border-radius: 24px; padding: 32px; border: 1px solid #e2e8f0;">
        ...
        <table style="width: 100%; border-collapse: collapse; font-size: 14px; color: #0f172a;">
          ...
          <tr><td style="padding: 8px 0; color: #64748b;">Mobile</td><td style="padding: 8px 0;">${mobileNumber}</td></tr>
        </table>
